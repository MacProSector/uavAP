...
#ifndef UAVAP_FLIGHTANALYSIS_STEADYSTATEANALYSIS_METRICS_H_
#define UAVAP_FLIGHTANALYSIS_STEADYSTATEANALYSIS_METRICS_H_
...
#endif /* UAVAP_FLIGHTANALYSIS_STEADYSTATEANALYSIS_METRICS_H_ */
